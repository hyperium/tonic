...
pub struct ServerReflectionRequest {
    #[prost(string, tag = "1")]
    pub host: tonic::prost::alloc::string::String,
...
pub mod server_reflection_request {
    ...
    /// fields in message_request. The server distinguishes requests by their
    /// defined field and then handles them using corresponding methods.
    #[derive(Clone, PartialEq, Eq, Hash, tonic::prost::Oneof)]
    pub enum MessageRequest {
        /// Find a proto file by the file name.
        #[prost(string, tag = "3")]
        FileByFilename(tonic::prost::alloc::string::String),
        /// Find the proto file that declares the given fully-qualified symbol name.
        /// This field should be a fully-qualified symbol name
        /// (e.g. <package>.<service>\[.<method>\] or <package>.<type>).
        #[prost(string, tag = "4")]
        FileContainingSymbol(tonic::prost::alloc::string::String),
        ...
        /// <package>.<type>
        #[prost(string, tag = "6")]
        AllExtensionNumbersOfType(tonic::prost::alloc::string::String),
        /// List the full names of registered services. The content will not be
        /// checked.
        #[prost(string, tag = "7")]
        ListServices(tonic::prost::alloc::string::String),
    }
}
...
pub struct ExtensionRequest {
    ...
    #[prost(string, tag = "1")]
    pub containing_type: tonic::prost::alloc::string::String,
    #[prost(int32, tag = "2")]
...
pub struct ServerReflectionResponse {
    #[prost(string, tag = "1")]
    pub valid_host: tonic::prost::alloc::string::String,
...
pub mod server_reflection_response {
    /// The server sets one of the following fields according to the
    /// message_request in the request.
    #[derive(Clone, PartialEq, tonic::prost::Oneof)]
...
pub struct FileDescriptorResponse {
    ...
    pub file_descriptor_proto: tonic::prost::alloc::vec::Vec<
...
pub struct ExtensionNumberResponse {
    ...
    /// is <package>.<type>
    #[prost(string, tag = "1")]
    pub base_type_name: tonic::prost::alloc::string::String,
    #[prost(int32, repeated, tag = "2")]
    pub extension_number: tonic::prost::alloc::vec::Vec<i32>,
}
...
pub struct ListServiceResponse {
    ...
    pub service: tonic::prost::alloc::vec::Vec<ServiceResponse>,
}
...
pub struct ServiceResponse {
    ...
    /// is <package>.<service>
    #[prost(string, tag = "1")]
    pub name: tonic::prost::alloc::string::String,
}
...
pub struct ErrorResponse {
    ...
    pub error_code: i32,
    #[prost(string, tag = "2")]
    pub error_message: tonic::prost::alloc::string::String,
}
